...
public class Match {
    ...
    public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink, String txtComplete, MatchStatus status, Date date) {
    ...
    public void setTxtComplete(String txtComplete) {
        this.txtComplete = txtComplete;
    }
